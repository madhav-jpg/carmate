<?php
        ...
        {
            $q=mysqli_query($c,"select password from admin where mob_num='".$_SESSION['adm_num']."'");
            ...
            if(($info['password']==$_POST['old_pass'])&&($_POST['new_pass']==$_POST['re_pass']))
            {
                ...
                if(mysqli_query($c,"update admin set password='".$_POST['new_pass']."' where mob_num='".$_SESSION['adm_num']."'"))
                {
