<?php
        ...
        {
            $qry="update admin set f_name='".$_POST["f_name"]."', s_name='".$_POST["s_name"]."', email='".$_POST["email"]."', city='".$_POST["city"]."', pincode=".$_POST["pincode"]." where mob_num=".$_SESSION["adm_num"];
...
<input type="number" name="mob_num" class="form-control" placeholder="Number" <?php echo "value=".$_SESSION['adm_num']; ?> disabled> 
</div> 
</div> 
